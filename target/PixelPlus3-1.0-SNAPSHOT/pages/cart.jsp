...
<!-- ============================================ for each start ============================================ -->
                                                <c:forEach var="c" items="${sessCartList}">
							<tr class="alert borx" role="alert">
						    	<td>
						    	...
						    	<td>
                                                            <div class="img" style="background-image: url(images/${c.image});"></div>
						    	</td>
						      	<td>
                                                            <div class="email">
						      		<span>${c.title}</span>
